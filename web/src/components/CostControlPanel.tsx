    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
            <CxIconDollarSign className="w-5 h-5 text-green-600" />
            成本控制
          </h2>
          ...
          {alerts.map((alert) => (
            ...
            >
              <div className="flex items-center gap-3">
                <CxIconAlertTriangle className="w-5 h-5 text-red-600" />
                <div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-gray-900 flex items-center gap-2">
              <CxIconTarget className="w-5 h-5 text-gray-600" />
              总体概览
            </h3>
      ...
      {budgets.length > 0 ? (
                ...
                <div className="flex items-center justify-between text-xs text-gray-500">
                  <div className="flex items-center gap-4">
                    <span className="flex items-center gap-1">
                      <CxIconBell className="w-3 h-3" />
                      告警阈值: {(budget.alert_threshold * 100).toFixed(0)}%
                    </span>
                    {budget.last_reset && (
                      <span className="flex items-center gap-1">
                        <CxIconClock className="w-3 h-3" />
                  ...
                  <div className="flex items-center gap-1">
                    {budget.enabled ? (
                      <>
                        <CxIconCheckCircle className="w-3 h-3 text-green-500" />
                        <span className="text-green-600">已启用</span>
                      </>
                    ) : (
                      <>
                        <CxIconClose className="w-3 h-3 text-gray-400" />
        ...
        <div className="bg-gray-50 rounded-xl p-12 text-center">
          <CxIconDollarSign className="w-12 h-12 text-gray-300 mx-auto mb-4" />
