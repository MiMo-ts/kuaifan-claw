                ...
                >
                  <div className="flex items-center">
                    {skill.downloaded ? (
                      ...
                      <CxIconAlertCircle className="w-4 h-4 text-yellow-500 mr-2 shrink-0" />
                    )}
                    <div>
              ...
              <div className="space-y-1">
                {downloadResults.map((r, i) => (
                  <div key={i} className="flex items-start text-sm gap-2">
                    {r.status === "success" ? (
                      <CxIconCheckCircle className="w-4 h-4 text-green-500 mr-0 shrink-0 mt-0.5" />
                    ) : r.status === "failed" ? (
                      <CxIconAlertCircle className="w-4 h-4 text-red-500 mr-0 shrink-0 mt-0.5" />
                    ) : (
                      <CxIconAlertCircle className="w-4 h-4 text-yellow-500 mr-0 shrink-0 mt-0.5" />
                    )}
                    <span
                      className={
                        r.status === "skipped"
