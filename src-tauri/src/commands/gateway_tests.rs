...
mod tests {
    ...
    fn test_agent_id_matches_account_id_per_instance() {
        ...
        let instances = vec![
            ...
            MockInst {
                id: "inst_003".into(),
                channel_type: "qq".into(),
            },
            MockInst {
                id: "inst_004".into(),
                channel_type: "wxwork".into(),
            },
        ];
        ...
        assert_eq!(results[2].1, "qq-inst_003");
        assert_eq!(results[3].1, "wxwork-inst_004");
    ...
    fn test_non_feishu_account_id_format() {
        ...
        assert_eq!(
            channel_account_id("wxwork", "inst_002"),
            "wxwork-inst_002"
        );
        assert_eq!(
            channel_account_id("wechat_clawbot", "inst_003"),
            "wechat_clawbot-inst_003"
        );
    }
    ...
    fn test_seen_agent_ids_dedup() {
        ...
        let accounts = vec![
            ...
            MockAcct {
                agent_id: "qq-inst_c".into(),
            },
            MockAcct {
                agent_id: "qq-inst_d".into(),
            },
        ];
        ...
        assert_eq!(
            written,
            vec!["inst_a", "inst_b", "qq-inst_c", "qq-inst_d"]
        );
    }
